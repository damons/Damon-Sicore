...
\newcommand{\SicoreAddress}{\textsc{Damon Sicore} \\ 132 Ridge Crest Street \\ Red Oak, TX 75154}
%\pagestyle{fancy}
%\lhead[]{}
%\rhead[]{}
%\headrulewidth 0pt
%\cfoot[\thepage \\ \SicoreAddress ]{ \thepage \\ \SicoreAddress }
\thispagestyle{empty}
\author{Damon Sicore}
\title{Damon Sicore}
...
\item{\emph{Special Interests:}}  Trust-based Artificial Intelligence, A.I.
Pedagogies, Natural Language Processing, Collaborative Computational Topic
Modeling, Logic Programming, Mathematics:  Trust Metrics, Computational
Linguistics, Graph and Search Theory, Computational Topology, Machine Learning,
Statistical Modeling, Cellular Automata, Probablility Theory.

\item{\emph{Primary Knowledge Languages:}} Prolog 35 yr.\footnote{This is an attempt at humor as I've been intrigued by Prolog since I was age 12; however I've only used it professionally in recent years as hardware has finally caught up to support it.}, Java 15 yr.,  C++ 6
yr., C 8 yr.

\item{\emph{Primary Knowledge:}} Programming Languages, Logic and Functional
Programming, Distributed Development Methodologies: Agile, Extreme Programming,
etc., Operating Systems, Networks, and Software Engineering, Organizational
Behavior, Psychology and Group Psychotherapy, and Leadership.

\item{\emph{Language Knowledge:}} Rust, Haskell, JavaScript, Python, Ada,
Pascal, Lisp, Fortran, Motorola 680x0 Assembly, IBM 370 Assembly, Numerous
markup languages like HTML, SQL and PL/SQL.

\item{\emph{Additional Knowledge:}} Cryptography and digital security
(encryption technologies), Embedded systems, peer-to-peer agents, blockchain theory and applications, JBoss AS Applied Architectures, System Administration
(router and firewall configuration, Sendmail, ipchains, DNS/bind, Tripwire,
Linux kernel, bash, sed, awk, backup and recovery, Samba, NFS, LDAP,  PGP/gnupg,
clustering and load-balancing, and general TCP/IP networking).

\item{\emph{Leadership Knowledge:}} Experienced executive capable of leading all
aspects of a company in addition to engineering and product management.
Organizational Development, Management Systems and Control (Project Management),
Software Configuration Managment, Organizational Behavior, Human Resource
Management, and the Management Process.  Professional leadership consultant and
mentor.
...
%\subsubsection*{Smartix International, Inc. -- \emph{April 2002 to December 2002}} \emph{Director of Product Development--}  Responsible for the Interface Engine development team, schedules, and product implementation.  Also, acting as technical architect on all enterprise development efforts.  Smartix' product is a J2EE product consisting of Weblogic, Resin, JBoss, SQLServer and open source databases.
...
\subsection*{EXPERIENCE, CONT.:}
 ...
 \end{description}
  ...
  \end{description}
%
%  \subsubsection*{MicroAge \emph{January 1993 - June 1994}}
%  \begin{description}
%    \item{\bf{\emph{Builder:}}} Duties include the assembly, configuration, and
%    installation of PC's.  Other Duties include on-site service, installation
%    of networking hardware, configuration of Novell Netware Operating System,
%    configuration and installation of Windows and Windows NT for the clients
%    needs in a networking environment, acquisition of task-specific hardware
%    and software for the client's specific applications, and Clipper database
%    programming.  The working environment emphasized teamwork to complete
%    scheduled builds, installations and projects on time.
%  \end{description}
